...
# ╔═╡ 8227f75c-c424-41b0-b3f6-857600e57e5e
begin
	using Images, TestImages
	img = Gray.(testimage("house"))
end

# ╔═╡ 52a51ef0-387b-11ee-1a9e-ddd07f523009
md"""
# Detecting Corners
- Author: Jivtesh Jain | 2020-07-01
...
# ╔═╡ c6dd9189-d2e7-43d8-99f6-972589bd1b73
md"""
...
# ╔═╡ 496339a9-5ab1-4aec-8d3b-bf0f24b19856
begin
	
	corners1 = imcorner(img)
	img_copy = RGB.(img)
	img_copy[corners1] .= RGB(1.0, 0.0, 0.0)
	img_copy
	
end

# ╔═╡ 0b5c7c46-5b8e-474d-88bb-588bb8e1245b
md"""
...
# ╔═╡ b66a8dcf-c93b-4e83-b0b9-24b27393e3cc
begin
	corners2 = imcorner(img, Percentile(98.5))
	img_copy2 = RGB.(img)
	img_copy2[corners2] .= RGB(1.0, 0.0, 0.0)
	img_copy2
end

# ╔═╡ 8eab6d65-143a-48f9-8d47-1caac6d28828
md"""
...
# ╔═╡ 10791cf7-404a-433e-b033-6192f1837ef0
begin
...
# ╔═╡ a6541a8b-00ec-42ce-a561-aae284ccb69a
md"""
...
# ╔═╡ 6d4a0c1a-735c-4b33-91d3-893a19273bd0
begin
	corners3 = fastcorners(img, 11, 0.1) # fastcorners(img, n, t) where n and t are optional
	img_copy3 = RGB.(img)
	img_copy3[corners3] .= RGB(1.0, 0.0, 0.0)
	img_copy3
end

# ╔═╡ 42ef6112-02a5-40f5-876f-b9a6f6b2d595
md"""
# References:
- Original Demonstration: [Detecting Corner Demo on JuliaImages website](https://juliaimages.org/latest/examples/contours/detecting_corners/#Detecting-Corners)
"""
