...
# ╔═╡ 9d3f5446-00e6-4aa7-8980-ef0fd611dca7
begin
...
# ╔═╡ 4e4292b2-387c-11ee-22a8-ab49afd7bfe3
md"""
# Canny Edge Detection
- Author: Ashwani Rathee; Johnny Chen | 2021-3-20
...
# ╔═╡ 2aa761f1-9113-431e-b7f6-7a5d224a78d9
md"""
!!! info
...
# ╔═╡ ec234e18-80b0-4840-b029-b8d20a75d876
begin
...
# ╔═╡ 127f684c-5ee6-4867-9ba0-b20224847bf2
md"""
...
# ╔═╡ 77703748-c944-44d8-a0eb-4bf8aa1e80b6
alg = Canny(spatial_scale=1, high=Percentile(80), low=Percentile(20))

# ╔═╡ 4e3b29c4-6853-45db-b882-36eea7166535
md"""
...
# ╔═╡ acba26da-bc40-4319-bb01-0320463409e5
begin
	edges = detect_edges(img, alg)
	mosaicview(img, edges; nrow=1)
end

# ╔═╡ 2af327ee-cdc0-45ee-bea4-3b88c56c2335
md"""
...
# ╔═╡ 16ee2835-9405-4c2e-8b72-95f328dacd89
begin
...
# ╔═╡ 192ad8fa-8baa-4e94-9582-8b0b057d0f9d
md"""
...
# ╔═╡ 3ee5428f-5e0a-4ebb-874e-5419644cba97
md"""
# References

- J. Canny, "A Computational Approach to Edge Detection," in _IEEE Transactions on Pattern Analysis and Machine Intelligence_, vol.
PAMI-8, no. 6, pp. 679-698, Nov. 1986, doi: 10.1109/TPAMI.1986.4767851.

- Original Demonstration: [Canny Edge Detection Demo on JuliaImages website](https://juliaimages.org/latest/examples/contours/canny_edge_demo/#Canny-Edge-Detection)
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "24a5090f7ba411b066ef19a2dff0aaf2bb6dd1e8"
