...
# ╔═╡ 308ef460-fcda-489d-b690-37400ab78dfc
using Images, FileIO, Plots     

# ╔═╡ e9d23d82-3984-11ee-071e-155859102afa
md"""
...
# ╔═╡ f8481c39-ff0b-41a0-8716-0477c08b241b
pwd()

# ╔═╡ 16a0bb08-d8d1-41f7-8932-98c633e86b73
cd(pwd())

# ╔═╡ eda509e1-4116-427a-b593-42748091cd35
md"""
Let's load the agarplate image that we want to learn some analytics on.
"""

# ╔═╡ fddccece-ffc1-4fe9-94ee-7d56ac144828
...
# ╔═╡ 63f5b08c-cbc8-4993-b2f6-c319dbc617f8

img = imresize(get_image("https://raw.githubusercontent.com/JuliaImages/JuliaCon23_ImageProcessingWorkshop/main/assets/agarplate.png"), (400,400))

# ╔═╡ 95b8d6fb-f29b-4154-b720-0098b8b8ad63
md"""
...
![](https://raw.githubusercontent.com/JuliaImages/JuliaCon23_ImageProcessingWorkshop/a97f9b23bc9378ce22c09a2614ca16cd39534af4//assets/agarplatesize.png)
"""

# ╔═╡ 71195195-5abd-4279-a552-341ce136a3a3
begin
	imgg = Gray.(img)
	bw = erode(imgg .> 0.52)
...
# ╔═╡ 4bcc9f95-d41e-4867-82f6-e071d77ac64a
md"""
...
# ╔═╡ d463043b-fa88-4a07-baac-86ff7a4eb22e
bw_transform = feature_transform(bw)

# ╔═╡ cb8409b6-da4b-4298-a887-bd71fb69cef4
md"""
...
# ╔═╡ 16dba6ff-9ac0-4029-ae0b-fe759e761861
begin
...
# ╔═╡ 72754b95-6b01-4d1f-8fa5-2b489f51d8cb
md"""
...
# ╔═╡ f5005415-b4ec-4cfa-bde6-a39c7c73c1b8
begin
...
# ╔═╡ 373cf6df-bca5-407b-8396-a138917b0ef2
md"""
...
![](https://raw.githubusercontent.com/JuliaImages/JuliaCon23_ImageProcessingWorkshop/a97f9b23bc9378ce22c09a2614ca16cd39534af4/assets/image.png)
"""

# ╔═╡ c98e34cb-9d63-459d-bde2-bbab388e943b
segments = watershed(imgg, markers)

# ╔═╡ c26d1f77-5406-4b9f-8663-eda1d9afe78d
md"""
`segments` is of type SegmentedImage{Matrix{Int64}, Gray{Float32}}.
"""

# ╔═╡ 4f6e2213-231b-4d3f-8662-45b770048d39
segments.segment_pixel_count

# ╔═╡ 1d4bf951-73ca-402a-a8cb-500d9ddab3e8
begin
...
# ╔═╡ 6ea95d9d-8eac-4db9-ad0f-8b63097b7e9d
begin
...
# ╔═╡ f4262381-1ca1-454a-b11b-011ba9d1f553
struct blob
    pixel_count::Int
...
# ╔═╡ 93196e15-e983-4600-beb8-c103e83f23d7
res = map(x->blob(x, markers), sort(unique(markers)));

# ╔═╡ 3800ba6d-5490-4f63-9c13-4b441c2fd7ce
map(x->x.img1, filter(x-> x.area < 2000 && x.area > 10, res))

# ╔═╡ 2c2d6b2b-61a3-4192-a88a-1f7fc34df43a
md"""
#### Credits:
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "b5a4a3435ba973c34c4d7678acd6bcd584c4bfa8"
