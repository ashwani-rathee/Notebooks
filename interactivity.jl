...
# ╔═╡ 1d0bd73e-313f-11ee-3139-85db732d880c
using Images, FileIO, TestImages, PlutoUI

# ╔═╡ 9acaf9bf-c86f-4017-b3e9-20df79ddfde9
md"""
## Interactivity with Images through PlutoUI

Being able to engage with and manipulate images in a dynamic way is exciting. It helps with facilitating better analysis, more insights and better user experience. 

Below is just a very small demonstration that explores how Pluto can be useful in dynamic workflows and analysis.

This was outcome of discussion here: https://github.com/JuliaImages/ImageView.jl/issues/287
"""

# ╔═╡ cb5052c3-fa06-4ba7-ba98-0017a397c6d1
img = testimage("mandrill");

# ╔═╡ bd0f739c-745d-4191-96e2-9242f56aed6d
begin
...
x_size1 = @bind x_size Slider(1:5:512; default=250, show_value=true)
y_size1 = @bind y_size Slider(1:5:512; default=250, show_value=true)

rot_angle = @bind rot Slider(0:pi/30:2*pi; default=0, show_value=true)
md"""
**Parameters?**

| Start     | End       | Resize | Misc | 
|:---------:|:---------:|:------:|:-----:|
| x1: $(x1) | x2: $(x2) | r-size: $(x_size1) | Color: $(color_img) |
| y1: $(y1) | y2: $(y2) | r-size: $(y_size1) |	Rotation: $(rot_angle) |
"""
end

# ╔═╡ 18bee316-f345-48ef-8c89-76abfa9b5a3e
img_small = imrotate(imresize(color.(img[a:b, c:d]), (x_size,y_size)), rot)

# ╔═╡ 9fd61a5a-3a7e-4294-9364-fbbce06525c4
md"""
# References:
- Original Gist: https://gist.github.com/ashwani-rathee/4211eec75ebdc8becd31ac1c38f50a6b
"""
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "a0c476de17c59f4267db2bcd19b1209e64bef3c9"
