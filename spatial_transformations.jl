...
# ╔═╡ 148bc764-505c-4090-a068-9b025b312fdf
using Images, TestImages, OffsetArrays

# ╔═╡ 7b03e2e0-3877-11ee-225f-9f738a046fb7
md"""
# Cropping, Resizing and Rescaling
- Author : Ashwani Rathee |  2020-11-24
...
# ╔═╡ 5222766f-a0d2-4868-ae3b-a817434d5f8d
md"""
ImageTransformations is reexported by Images
load an example image
"""

# ╔═╡ af4ea415-38e2-4880-89af-9d8d230481dc
img_source = testimage("lighthouse")

# ╔═╡ 49fbce88-f850-433d-bf64-8937b16ee94e
md"""
## Cropping Operation
...
# ╔═╡ c70147b0-b48c-492b-98ed-aba8dedc1b8d
img_size = size(img_source)

# ╔═╡ 35e15644-276e-423a-bd63-1686742a7711
md"""
...
# ╔═╡ 92faca1f-d405-4aa3-b2ac-f30f1dad297b
img_cropped = @view img_source[ :,floor(Int, 1/8*img_size[2]) : floor(Int, 7/8*img_size[2])]

# ╔═╡ b5d5daa5-2b83-4c29-af20-3e850439d913
md"""
Let's see the size of the cropped image:
"""

# ╔═╡ fc0340d5-7a14-49cf-a40d-a1857e9302c5
size(img_cropped)

# ╔═╡ 1877015c-0800-43d3-87c2-c7484353e1a6
md"""
...
# ╔═╡ 0d06ee85-3cf4-462c-80f4-eef9ea8c5ef9
begin
...
# ╔═╡ da84f804-bee6-4bac-9b43-ed227f5bd73f
md"""
## Rescaling
...
# ╔═╡ 1c022791-8570-4be9-b318-8c42fe254003
begin
...
# ╔═╡ 2c409bc9-77d3-442c-9216-1e70f59434c2
md"""
...
# ╔═╡ 9b668189-a801-4c01-82aa-1c35330be71d
begin
	new_width = 200
	percentage_scale_d = new_width / size(img_source,2);
	new_size_d = trunc.(Int, size(img_source) .* percentage_scale_d);
	img_rescaled_d = imresize(img_source, new_size_d);
	mosaicview(img_source, img_rescaled_d; nrow=1)
end

# ╔═╡ 81224ecc-e639-4d80-97cb-766ac246581e
md"""
...
# ╔═╡ b9342f91-9ea5-43fa-9177-e8b9aba11425
begin
...
# ╔═╡ 13029d0c-f704-431b-9d72-ccf7d87ccc76
md"""
# References:
- Original Demonstration: [Spatial Transformation Demo on JuliaImages website](https://github.com/JuliaImages/juliaimages.github.io/blob/source/docs/examples/spatial_transformation/SpatialTransformations.jl)
"""
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "508afc6fed4e79fe640e928b0a56f8bafd19a673"
