...
# ╔═╡ ee060cea-e493-409b-b00e-29f7a0114738
begin
	using Images, Noise, ImageDraw
	using TestImages
end

# ╔═╡ 467a2aa1-6a5e-4655-9bd9-4a4c57dfc12f
md"""
## Convex Hull, Filling, Thinning, ClearBorder
- Author: Ashwani Rathee | 2021-7-4
...
# ╔═╡ 5a02bb64-13df-4385-9566-36090687a461
img_src = testimage("morphology_test_512")

# ╔═╡ a61d1596-6a70-4a6b-8439-c161f05d697f
md"""
Thresholding of image
"""

# ╔═╡ fc8ddb3e-6f76-42af-b9c8-df61513db7a6
img_input = binarize(Gray.(img_src), UnimodalRosin()) .> 0.5

# ╔═╡ e4a22550-0930-4e55-a275-5e183c762a0e
md"""
...
# ╔═╡ 85d00330-6e63-43c5-819a-359663013662
Gray.(img_input)

# ╔═╡ b42ae22f-1b3e-4a8c-983d-8d72c14c1379
md"""
## Convex Hull
...
# ╔═╡ 5daba8f8-a4ab-41ef-8ac3-75ccc343c96d
begin
...
# ╔═╡ 5ce66463-f243-4393-b075-49afd82f299a
md"""
## Image Filling
...
# ╔═╡ 8a6903c3-ca9d-4d8e-b8c2-b4beb177ce51
begin
...
# ╔═╡ 94cb60c2-96cf-4078-9bc6-cf58a30f24f8
Gray.([img_noise fill_image_1 fill_image_2 fill_image_3 fill_image_4])

# ╔═╡ 73e7f949-dd05-4984-908e-3d1d6095eead
md"""
## Image thinning
...
# ╔═╡ 10562630-6c76-4f73-b080-9ad5a758e24f
begin
	img_thinning = thinning(img_input, algo = GuoAlgo());
	Gray.([img_input img_thinning])
end

# ╔═╡ f499eb23-7aec-4398-85c5-d5143411b5d2
md"""
## Clear Border
...
# ╔═╡ d25227d2-a4d0-4383-95e6-c53cb9db1214
begin
...
# ╔═╡ 0dc91fe0-3883-11ee-2ec3-33d0e7df1d89
md"""
# References:
- Original Demonstration: [Morphological Operations Demo on JuliaImages website](https://juliaimages.org/latest/examples/image_morphology/morphological_operations/#Convex-Hull,-Filling,-Thinning,-ClearBorder)
"""
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "94d406d8138b4666cf98afecaad5b52ac6daff69"
