...
# ╔═╡ db6af672-7dc5-425b-908d-f2d0c716ad00

using Pkg

# ╔═╡ 25545750-23f8-11ee-307c-a5307bac7749
using ObjectDetector, Images, FileIO, TestImages

# ╔═╡ addb479d-a47e-43ac-80e1-9c734bcad127
using VideoIO

# ╔═╡ 08d28d27-512a-4c7d-9965-e7dfcafe5dc4


# ╔═╡ e6dc3c25-1913-469a-b4d7-791d73bd0419
begin
	
f = VideoIO.openvideo("traffic.mp4")
fps = VideoIO.framerate(f)
i = 0
end

# ╔═╡ f07ee5d8-e93a-4fd2-b373-0150001e822f
# ╠═╡ disabled = true
#=╠═╡
r = testimage("cameraman")
  ╠═╡ =#

# ╔═╡ 3b069e55-5269-40df-bd43-db2f3a6da742
# ╠═╡ disabled = true
#=╠═╡
@bind r img
  ╠═╡ =#

# ╔═╡ 9824f8bc-8850-4ac0-8f5e-dc0a9c7cb12f
begin
...
# ╔═╡ d7654832-b2e8-4198-9727-a78a4c922cc5
close(f)

# ╔═╡ 9ab12cc0-739b-472e-861b-e581a3defb50
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "564116d69e5a5586f9068e8dae0854f56d38e97d"
...
git-tree-sha1 = "25e04f400855fd37ea1167a4f0c8a575b0dfaabc"
...
[[deps.VideoIO]]
deps = ["ColorTypes", "Dates", "Downloads", "FFMPEG", "FileIO", "Glob", "ImageCore", "Libdl", "PrecompileTools", "ProgressMeter", "Requires"]
git-tree-sha1 = "8fbbea533756fc1dd830f9438eb985e6adad585c"
