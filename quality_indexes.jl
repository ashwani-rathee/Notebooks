...
# ╔═╡ efec2cd2-9623-4dd6-a546-41f9be1b4087
begin
	using Images, TestImages
	using Random
end

# ╔═╡ 66e0c1df-85ed-4d11-a0ab-1db8c1351d34
md"""
#### Structural Similarity Index, Peak Signal-to-Noise Ratio
- Author: Jivetesh Jain | 2020-07-01
...
# ╔═╡ 4d089abd-aedd-48bb-b538-6a4c05af226d
img_orig = float64.(testimage("cameraman"))

# ╔═╡ ae28d1c6-af96-45e2-8e9e-d2e1debc580b
md"""
...
# ╔═╡ e43cad11-0c8e-41a2-b030-6bc47ff72f29
assess_ssim(img_orig, img_orig)

# ╔═╡ 27625f1f-71c2-4d30-9613-2a1865e46bb5
md"""
...
# ╔═╡ 0175190c-98bd-4890-bb60-609724e5ec9b
begin
...
# ╔═╡ 10be85b5-a4e1-4f66-a5f5-a9514486173c
md"""
...
# ╔═╡ 2af59fd0-ac3d-49b5-9f5e-14c2cabe2d43
mse(img_orig, img_const), mse(img_orig, img_noise)

# ╔═╡ 0991e673-5d96-4f2c-966b-27b3a30878d1
md"""
...
# ╔═╡ 5849ac72-f0be-4d06-8635-c2066dc0071e
assess_ssim(img_orig, img_const), assess_ssim(img_orig, img_noise)

# ╔═╡ d6b05d1b-98b9-461c-a52a-33db13ee7bc2
md"""
...
# ╔═╡ 72107edc-a9c9-4e28-8e8b-eecde363ba27
begin
...
# ╔═╡ 8d580cd6-261a-498d-b54f-f78f4623b995
md"""
...
# ╔═╡ cacef166-d8e0-4d27-99ca-84c909529649
begin
	noise1 = ones(size(img_orig)) .* 0.2 .* (maximum(img_orig) - minimum(img_orig))
	mask1 = rand(Float64, size(img_orig)) .< 0.5
	noise[mask1] = noise1[mask1] .* -3
	img_noise1 = img_orig + noise1
	
	assess_psnr(img_noise1, img_orig)
end

# ╔═╡ 2be613b0-0df4-45f4-b48b-05f43ac9fdcc
md"""
...
# ╔═╡ d8184570-3881-11ee-0e63-8bc69e8de43c
md"""
### References
...
- Original Demonstration: [Quality Indexes Demo on JuliaImages website](https://juliaimages.org/latest/examples/image_quality_and_benchmarks/structural_similarity_index/#Structural-Similarity-Index,-Peak-Signal-to-Noise-Ratio)
"""
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "727e663d1136effcbe5e4273087a833d654efa41"
