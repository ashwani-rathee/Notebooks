...
# ╔═╡ 7d17b7cf-b33a-4e85-80b0-392493c942c8
using Images, TestImages

# ╔═╡ 258f1eed-a0c5-4b8f-b14b-9fab53d272e5
md"""

# Morphological Operations
- Author: Ashwani Rathee | 2021-7-2
...
# ╔═╡ 848403d0-7af1-4ded-883c-70a09660025e
img = Gray.(testimage("morphology_test_512"))

# ╔═╡ a562a0d3-f610-4522-b6c6-7443ab50a399
md"""
## Erosion
...
# ╔═╡ 4cece745-2c96-4e17-b6ed-0c59a7737bcd
begin
...
# ╔═╡ 0cb9b1b0-c473-43f7-b01d-46dbfaf1a16d
md"""
## Dilation
...
# ╔═╡ 4c30021b-df63-4c31-93c3-5b8ee5a15133
begin
...
# ╔═╡ 33be7adf-c519-49e5-aa3c-740ebdcf8b47
md"""
## Opening
...
# ╔═╡ b8770803-b53e-4588-af85-d1fc109a0f29
begin
...
# ╔═╡ 1d97cdfa-938b-4e41-8bea-3cf99a94a919
md"""
## Closing
...
# ╔═╡ e81f0587-5c4c-4518-b067-03bf75175333
begin
...
# ╔═╡ 58e8260c-50c8-48ef-b15f-6f2ed7289d31
md"""
## Tophat
...
# ╔═╡ 194fd1b5-fefc-4f5c-af54-05a4b2e78111
begin
...
# ╔═╡ 4b137787-368d-4649-9168-a87b731da0da
md"""
## Bottom Hat
...
# ╔═╡ f2e22038-a67b-47e2-92d9-3381dee2e9f9
begin
...
# ╔═╡ 1debe6d1-ce69-4c20-92a9-bfbf2982bc5f
md"""
## Morphology Gradient
...
# ╔═╡ cefaad65-4ed8-4678-b65b-e687fb9bfc6f
begin
...
# ╔═╡ 601cabe9-f7d7-4e0f-9952-540c8e9e0df8
md"""
## Morphological Laplace
...
# ╔═╡ 8aab9f56-285f-4c15-acfd-a9e603eb58b9
begin
	img_gray1 = @. Gray(0.8 * Gray.(img) > 0.7);
	img_morpholap = morpholaplace(img_gray1)
	mosaicview(img_gray1, img_morpholap; nrow = 1)
end

# ╔═╡ d19aca74-63c2-4076-9791-47caf2ee6d97
md"""
## References:
...
- Original Demonstration: [Image Morphology Demo on JuliaImages website](https://juliaimages.org/latest/examples/image_morphology/image_morphology/#Morphological-Operations)
"""
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "2dd5d5c52d82c5b104bc85b7d2fd68f788906fb9"
