...
# ╔═╡ 2cd627a9-cd4b-4f9f-b8c5-57a015db797b
using Images, TestImages

# ╔═╡ 92f9670c-fe83-4efb-88b8-108ee6c16037
md"""
# RGB to GrayScale
- Author: Gautam Mishra | 2020-07-01
This example illustrates RGB to Grayscale Conversion

"""

# ╔═╡ 269e41a7-b984-422a-ad44-c8599928b51c
rgb_image = testimage("lighthouse")

# ╔═╡ 945a04f9-e9d1-4a38-b2e6-b7eab3007737
md"""
`I = Gray.(rgb_image)` converts an RGB image to Grayscale. 
"""

# ╔═╡ 680720dc-b5ba-457d-b860-c16b1462b6cd
begin
	gray_image = Gray.(rgb_image)
	mosaicview(rgb_image, gray_image; nrow = 1)
end

# ╔═╡ 74a55704-a2f7-45fc-9cda-cf15821134b0
md"""
...
# ╔═╡ a598cec5-a777-4e83-ae58-5c26ac4d050d
md"""
# References:
- Original Demonstration: [RGB To GrayScale Demo on JuliaImages website](https://juliaimages.org/latest/examples/color_channels/rgb_grayscale/#RGB-to-GrayScale)
"""
